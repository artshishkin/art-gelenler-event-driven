...
@Profile("!gelenler")
public class ArtAnalyticsKafkaConsumer implements KafkaConsumer<TwitterAnalyticsAvroModel> {
    ...
    public void receive(
        ...
        List<AnalyticsEntity> saved = analyticsRepository.saveAll(analyticsEntities);
        log.debug("{} number of messages send to database", saved.size());
