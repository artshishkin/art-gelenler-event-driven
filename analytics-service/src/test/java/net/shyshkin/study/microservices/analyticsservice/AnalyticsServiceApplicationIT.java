...
@Testcontainers
class AnalyticsServiceApplicationIT extends KeycloakAbstractTest {
    ...
    void getWordCountByWord_ok() {
        ...
        var responseEntity = testRestTemplate
                .exchange(requestEntity, AnalyticsResponseModel.class);

        //then
        assertThat(responseEntity.getStatusCode()).isEqualTo(HttpStatus.OK);
        AnalyticsResponseModel body = responseEntity.getBody();
        assertThat(body)
                .isNotNull()
                .hasNoNullFieldsOrProperties();
        assertThat(body.getWord()).isEqualTo(word);
        assertThat(body.getWordCount()).isEqualTo(123L);
    ...
    void getWordCountByWord_withoutAuthHeader_unauthorized_401() {
        ...
        //when
        var responseEntity = testRestTemplate
                .getForEntity("/get-word-count-by-word/{word}", AnalyticsResponseModel.class, word);
    ...
    void getWordCountByWord_withWrongAudience_thenUnauthorized_401() {
        ...
        assertThat(responseEntity.getBody()).isNull();
        assertThat(responseEntity.getHeaders().getFirst("WWW-Authenticate"))
                .contains("An error occurred while attempting to decode the Jwt: The required audience analytics-service is missing");
    }
